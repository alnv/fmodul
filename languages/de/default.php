...
$GLOBALS['TL_LANG']['MSC']['fm_criterion'] = 'Es wurde keine Beschreibung gefunden.';
...
$GLOBALS['TL_LANG']['MSC']['fm_activate_filter'] = 'Sie können das Feld: "%s [<em>%s</em>]" aktivieren, um eine SQL Abfrage zu generieren.';
$GLOBALS['TL_LANG']['MSC']['fm_field_ignore'] = 'Feld ignorieren';
$GLOBALS['TL_LANG']['MSC']['fm_field_ignore_desc'] = 'Dieses Feld wird ignoriert. Es wird keine SQL Abfrage generiert.';
$GLOBALS['TL_LANG']['MSC']['fm_highlight'] = 'Datensätze ein/ausblenden';
...
$GLOBALS['TL_LANG']['MSC']['fm_ff_form_type'] = array('Input-Type', 'Bitte wählen Sie ein Input-Type aus.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_template'] =  array('Template', 'Hier können Sie dem Eingabefeld ein Template zuweisen.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_class'] = array('CSS-Klasse', 'Hier können Sie eine oder mehrere CSS-Klassen eingeben.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_active'] = array('Eingabefeld einblenden', 'Hier können Sie das Eingabefeld im Formular einblenden.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_dependsOn'] = array('Feld-Abhängigkeit', 'Feld nur einblenden wenn ein bestimmtes Feld ausgewählt worden ist.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_changeOnSubmit'] = array('Change on submit', 'Die Seite wird neu geladen sobald ein Feld ausgewählt worden ist.');
