...
$GLOBALS['TL_LANG']['tl_fmodules_filters']['type'][1] = 'Wähle Sie einen Eingabefeld Typ aus.';
...
$GLOBALS['TL_LANG']['tl_fmodules_filters']['description'][1] = 'Geben Sie eine Eingabfeld Beschreibung ein.';

$GLOBALS['TL_LANG']['tl_fmodules_filters']['fieldAppearance'][0] = 'Style';
$GLOBALS['TL_LANG']['tl_fmodules_filters']['fieldAppearance'][1] = 'Wählen Sie eine Eingabfeld Darstellung im Backend aus.';
