...
$GLOBALS['TL_LANG']['MSC']['fm_activate_filter'] = 'Enable %s [<em>%s</em>] filter.';
$GLOBALS['TL_LANG']['MSC']['fm_field_ignore'] = 'Ignore field';
$GLOBALS['TL_LANG']['MSC']['fm_field_ignore_desc'] = 'This field will be ignored.';
...
$GLOBALS['TL_LANG']['MSC']['fm_operator_label'] = 'Choose operator';
$GLOBALS['TL_LANG']['MSC']['fm_operator_description'] = 'Please choose operator';
$GLOBALS['TL_LANG']['MSC']['fm_ff_no_list'] = "Please select your list.";
$GLOBALS['TL_LANG']['MSC']['fm_ff_name'] = "Field name";
$GLOBALS['TL_LANG']['MSC']['fm_ff_form_type'] = array('Input type', 'Please select your input type.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_template'] =  array('Template', 'Please select your template.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_class'] = array('CSS class', 'Here you can define your css classes.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_active'] = array('Enable field', 'Here you can enable your field.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_dependsOn'] = array('Field dependencies', 'Here you can set up field dependencies.');
$GLOBALS['TL_LANG']['MSC']['fm_ff_changeOnSubmit'] = array('Change on submit', 'Page will be load after enter a value.');
